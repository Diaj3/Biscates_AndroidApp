...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView regBtn = findViewById(R.id.registo_button);
        final TextView emailInput =  findViewById(R.id.email_login);
        final TextView passwordInput =  findViewById(R.id.pass_login);
